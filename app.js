...
document.incomeForm.incomeButton.addEventListener("click", function() {return submitOnClick();});
console.log(document.incomeForm.incomeButton.addEventListener("click", function() {console.log(submitOnClick())}));
